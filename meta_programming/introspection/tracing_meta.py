class TracingMeta(type):
    @classmethod
    def __prepare__(mcs, name, bases, **kwargs):  # tworzy namespace
    ...
    def __new__(mcs, name, bases, namespace, **kwargs):  # tworzy klasę
    ...
    def __init__(cls, name, bases, namespace, **kwargs):  # inicjalizuje klasę
...
# powyżej zastosowano wzorzec projektowy template - tworzy szablon postępowania, ale nie wymusza jak się tworzy każdy element
